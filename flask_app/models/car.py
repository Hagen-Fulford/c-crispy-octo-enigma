...
class Car:
    db_name = "car_dealz_three" #! update this to connect to the correct database 
    def __init__(self,dealz_data):
        self.id = dealz_data['id']
        self.price = dealz_data['price']
        self.model = dealz_data['model']
        self.make = dealz_data['make']
